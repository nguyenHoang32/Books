...
`,
    ...
    , loaiBia: 'Bìa mềm', kickThuoc: '13.5 x 20 cm'
},
{
...
},
{
    ...
    amount: 1,
    NXB: 'NXB tổng hợp TP.HCM',
    author: 'Craig Christensen, Sean Frontz',
    isSale: 25,
    page: 128,
    year: 2019,
...
Tác phẩm tiêu biểu Theo đuổi ký ức (Libre xuất bản)
 ...
 `,
    ...
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/i/m/image_180164_1_43_1_57_1_4_1_2_1_210_1_29_1_98_1_25_1_21_1_5_1_3_1_18_1_18_1_45_1_26_1_32_1_14_1_1236.jpg',
    name: 'TÔI LÀ BÊTÔ (TÁI BẢN 2018)',
    price: 85000,
    amount: 2,
    NXB: 'NXB Trẻ',
...
},
{
    ...
    page: 200,
    year: 2017,
    description: `Nếu Chỉ Còn Một Ngày Để Sống
        ...
        Cuốn sách giúp mùa hè của bạn trở nên đặc biệt ý nghĩa, còn chần chừ gì nữa mà không sở hữu ngay cuốn sách tuyệt vời này !`,
    Category: 'Văn học',
    subCategory: 'Tiểu thuyết'
    , loaiBia: 'Bìa mềm', kickThuoc: '13.5 x 20 cm'
},
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/b/1/b1-t_i-c_-m_t-ch_n-r_u.jpg',
    name: 'TÔI CÓ MỘT CHÉN RƯỢU, CÓ THỂ XOA DỊU HỒNG TRẦN',
    price: 109000,
    amount: 25,
    NXB: 'NXB Hồng Đức',
    ...
    page: 344,
    year: 2019,
    description: `Tôi Có Một Chén Rượu, Có Thể Xoa Dịu Hồng Trần
            ...
            * Giới thiệu tác giả:Quan Đông Dã Khách – nhà văn, biên kịch, người kể chuyện, thuộc chòm sao Ma Kết. Mong muốn dùng câu chữ để viết ra những lời bi ail y hợp mà ít người biết tới. Mong gặp gỡ một người xa lạ, bình dị cùng làm bạn giữa thành phố phồn hoa náo nhiệt này.`,
    Category: 'Văn học',
    subCategory: 'Ngôn tình'
...
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/f/f/ffff_2.jpg',
    name: 'CHÚNG TA',
    price: 199000,
    amount: 17,
    NXB: 'NXB Hà Nội',
    ...
    description: `Chúng Ta
                ...
                Câu hỏi vẫn luôn canh cánh nơi đáy lòng cô, hãy cứ để thời gian trả lời! `,
    Category: 'Văn học',
    subCategory: 'Ngôn tình'
...
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/c/h/checklist-thong-minh-cho-moi-du-an-_-outline-01.jpg',
    name: 'CHECKLIST THÔNG MINH CHO MỌI DỰ ÁN',
    price: 129000,
    amount: 11,
    NXB: 'NXB Lao Động - Xã Hội',
    ...
    page: 310,
    year: 2016,
    description: `Checklist Thông Minh Cho Mọi Dự Án

  CHECKLIST THÔNG MINH CHO MỌI DỰ ÁN chứa một loạt checklist quan trọng dành cho các nhà quản lý dự án. Nó cung cấp một nguồn gợi ý, bí kíp và hướng dẫn toàn diện giúp bạn hoàn thành các nhiệm vụ tại nơi làm việc cũng như bàn giao được các dự án tuyệt vời. Nhờ đó bạn sẽ:
  ...
  - Điều hành được bất cứ loại hình dự án nào, bất kể quy mô của nó lớn nhỏ ra sao;
  
  - Nhanh chóng tìm ra các giải pháp tối ưu trước mọi vấn đề phát sinh.
  
  Cuốn sách này sẽ đưa bạn đi qua tất cả các giai đoạn trong chu kỳ của một dự án, từ khi bắt đầu cho đến khi kết thúc. Chỉ với các danh sách kiểm tra này, bạn sẽ “công phá” được mọi dự án.`,
    Category: 'Kỹ năng',
    subCategory: 'Kỹ năng sống'
    , loaiBia: 'Bìa mềm', kickThuoc: '13.5 x 20 cm'
},
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/3/2/329274_p86400mscan0001.jpg',
    ...
    page: 400,
    year: 2018,
    description: `Đừng Lựa Chọn An Nhàn Khi Còn Trẻ
...
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/8/9/8936037797700.jpg',
    name: 'Tâm lí học hài hước',
    price: 108000,
    amount: 1,
    NXB: 'NXB Lao Động',
    ...
    page: 333,
    year: 2018,
    description: `Tâm Lý Học Hài Hước
...
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/d/i/dieu_gi_khien_khach_chi_tien_outline_24.4.2017-02.jpg',
    name: 'ĐIỀU GÌ KHIẾN KHÁCH HÀNG CHI TIỀN? (TÁI BẢN 2018)',
    price: 125000,
    amount: 1,
    NXB: 'NXB tổng hợp TP.HCM',
    ...
    page: 432,
    year: 2019,
    description: `Điều Gì Khiến Khách Hàng Chi Tiền? (Tái Bản 2018)
              ...
              Đầy ắp trong cuốn sách  Điều gì khiến khách hàng chi tiền? là những câu chuyện thú vị về cách chúng ta phản ứng đối với những thương hiệu được nhiều người biết đến như Marlboro, Nokia, Calvin Klein, Ford và chương trình giải trí American Idol, Mua hàng học là một hành trình vô cùng kỳ thú và hấp dẫn, đi sâu tìm hiểu trí óc của những người tiêu dùng hôm nay. Nó sẽ làm say đắm bất cứ ai đã từng một lần bị hấp dẫn – hoặc bị dẫn dụ - bởi những nỗ lực không mệt mỏi của các nhà quảng cáo nhằm chiếm được lòng tin, sự trung thành, tiền bạc và cả tâm trí của chúng ta.`,
    Category: 'Kinh tế',
    subCategory: 'Marketing'
    , loaiBia: 'Bìa mềm', kickThuoc: '13.5 x 20 cm'
},
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/i/m/image_183292.jpg',
    name: 'ĐỪNG BÁN BẢO HIỂM HÃY TRAO GIẢI PHÁP',
    price: 105000,
    amount: 1,
    NXB: 'NXB Tổng Hợp Đà Nẵng',
    author: 'Pilot Nguyễn',
    isSale: 22,
    page: 159,
    year: 2019,
    description: `“Đừng bán bảo hiểm - Hãy trao giải pháp” là cuốn sách tâm huyết của tác giả Pilot Nguyễn, người đã trưởng thành từ một tư vấn viên, nền tảng để anh có những trải nghiệm hữu dụng cho những vị trí quản lý cao cấp sau này.
...
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/i/m/image_180164_1_43_1_57_1_4_1_2_1_210_1_29_1_61.jpg',
    name: 'MÔ HÌNH PHÂN PHỐI VÀ BÁN LẺ (TÁI BẢN 2018)',
    price: 193000,
    amount: 1,
    NXB: 'NXB Lao Động',
    author: 'TS Đào Xuân Khương',
    isSale: 40,
    page: 250,
    year: 2018,
    description: `Các chuyên gia kinh tế nhận định rằng, thị trường bán lẻ Việt Nam nhiều năm qua vẫn duy trì kênh phân phối truyền thống thông qua các đại lý, cửa hàng bán lẻ nhỏ và tự phát. Đồng thời họ cũng dự báo rằng doanh số bán lẻ của Việt Nam trong các năm tới sẽ tiếp tục tăng, và thị trường bán lẻ Việt Nam có rất nhiều cơ hội, nhưng cũng sẽ không tránh được sự thâm nhập của các ông lớn trong ngành bán lẻ trên thế giới. Vậy làm thế nào các cửa hàng bán lẻ truyền thống, các siêu thị của Việt Nam có thể duy trì và phát triển trong tương lai?
    ...
    Câu trả lời nằm trong cuốn sách nhỏ Mô Hình Phân Phối Và Bán Lẻ nhưng giá trị thực tiễn vô cùng cao này.
    ...
    - Phần III. Mô hình phân phối hiệu quả.`,
    Category: 'Kinh tế',
    subCategory: 'Marketing',
    loaiBia: 'Bìa mềm',
    kickThuoc: '13.5 x 20 cm'
},
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/i/m/image_62528.jpg',
    name: 'TAM SINH TAM THẾ CHẨM THƯỢNG THƯ (TÁI BẢN)',
    price: 109000,
    amount: 17,
    NXB: 'NXB Văn Học',
    ...
    page: 464,
    year: 2017,
    description: `Tam Sinh Tam Thế Chẩm Thượng Thư (Tái Bản)
...
},
{
    ...
    subCategory: 'Ngôn tình',
    loaiBia: 'Bìa mềm',
    kickThuoc: '15 x 33 cm'
},
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/8/9/8934974137351.jpg',
    name: 'NẾU TÔI BIẾT ĐƯỢC KHI CÒN 20 (TÁI BẢN)',
    price: 64000,
    amount: 22,
    NXB: 'NXB Trẻ',
    author: 'Tina Seelig',
    ...
    page: 252,
    year: 2016,
    description: `Nếu Tôi Biết Được Khi Còn 20 (Tái Bản)
...
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/1/0/100ytuongkinhdoanhtuyethay.jpg',
    name: '100 Ý TƯỞNG KINH DOANH TUYỆT HAY (2017)',
    price: 134000,
    amount: 24,
    NXB: 'NXB Trẻ',
    ...
    page: 352,
    year: 2017,
    description: `100 Ý Tưởng Kinh Doanh Tuyệt Hay

    Bên cạnh những ý tưởng liên quan đến các lĩnh vực kinh điển của quản trị như quản trị nhân sự, nhượng quyền kinh doanh, cắt giảm lãng phí, lãnh đạo sự đổi mới… quyển sách tiếp cận rất nhiều lĩnh vực mới trong quản trị mà thế giới kinh doanh phải đối mặt ở hiện tại và tương lai bằng những ý tưởng và kiến thức được trình bày cô đọng, súc tích, dễ nắm bắt và vận dụng. Có thể nói 100 ý tưởng kinh doanh tuyệt hay là một chiếc thấu kính hội tụ đem nhiều vấn đề đã hiện ra ở đường chân trời lúc này rồi và đang lớn dần về đặt ngay trên bàn làm việc của các nhà quản lý nào còn chưa có sự chuẩn bị, thậm chí là chưa nhận ra chúng.
    ...
    loaiBia: 'Bìa mềm',
    kickThuoc: '15 x 22 cm'
},
{
    srcImg: 'https://cdn0.fahasa.com/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/u/n/untitled_1_2.jpg',
    name: 'KHÔNG BAO GIỜ LÀ THẤT BẠI! TẤT CẢ LÀ THỬ THÁCH (TÁI BẢN 2019)',
    price: 115000,
    amount: 24,
    NXB: 'NXB Trẻ',
    ...
    page: 352,
    year: 2019,
    description: `Không Bao Giờ Là Thất Bại! Tất Cả Là Thử Thách (Tái Bản 2019)
    ...
    Câu chuyện về cuộc đời của Chung Ju Yung cùng "triết lý con rệp" của ông là nguồn cảm hứng cho rất nhiều doanh nhân trẻ khởi nghiệp, trong đó có Đặng Lê Nguyên Vũ - người khai sinh ra thương hiệu cà phê Trung Nguyên nổi tiếng ngày nay.
    
    Đây sẽ là cuốn sách kinh doanh không thể thiếu của bạn.`,
    Category: 'Kinh tế',
    subCategory: 'Nhân vật-Bài học kinh doanh',
